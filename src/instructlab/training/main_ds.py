...
def train(args, model, tokenizer, train_loader, grad_accum, metric_logger, aim_run=None):
    with torch.no_grad():
        # model.train()
        model.eval()
...
def main(args):
    ...
    train(args, model, tokenizer, train_loader, grad_accum, metric_logger, aim_run=aim_run)
